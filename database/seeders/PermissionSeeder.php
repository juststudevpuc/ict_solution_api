...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $modules = [
            ...
            // ✅ UPDATED: Capitalized 'Career'
            ['module_name' => 'Career', 'key' => 'career', 'staff' => false, 'user' => false],

            // ✅ ADDED: Job Applications to match moduleKey="job-applications"
            ['module_name' => 'Job Applications', 'key' => 'job-applications', 'staff' => false, 'user' => false],
        ];
